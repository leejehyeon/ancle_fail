...
<?
						...
						if($category_title == $explode_category_top_array[0])
												{
?>
							<a href="/index.php/<?echo $explode_top_array[0]?>/<?if($explode_category_top_array[0]=="my_attendance"){echo $explode_category_top_array[0].'/'.date("Y/m");}else if($explode_category_top_array[0]=="attendance_record"){echo $explode_category_top_array[0].'/'.date("Y/m/d");?><?}else{echo $explode_category_top_array[0];}?>"><li class="sidebar_list"><p class="underline_title"><?echo $explode_category_top_array[1]?></p></li></a>						
<?
												}else{?>
